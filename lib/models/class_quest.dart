...
class AdventureQuest {
  ...
  static const allQuests = <AdventureQuest>[
    ...
    AdventureQuest(id: 'adv_29', chapter: 'Transcendence', questIndex: 28,
      title: 'Ascend a Tier', hint: 'Clear the campaign to unlock your first difficulty Tier.',
      description: 'Unlock your first difficulty Tier by defeating the final boss.',
