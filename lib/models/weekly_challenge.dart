class WeeklyChallenge {
  ...
  static List<WeeklyChallenge> generateForWeek(int weekSeed) {
    final pool = [
      () => WeeklyChallenge(id: 'w_kills', name: 'Slaughter', description: 'Kill 500 enemies', target: 500, rewards: {'echoes': 200, 'crystals': 30}),
      () => WeeklyChallenge(id: 'w_pvp', name: 'Arena Legend', description: 'Win 20 PvP battles', target: 20, rewards: {'gemShards': 100, 'crystals': 25}),
      () => WeeklyChallenge(id: 'w_dungeon', name: 'Depths', description: 'Clear 30 dungeon floors', target: 30, rewards: {'essence': 300, 'mythril': 15}),
      () => WeeklyChallenge(id: 'w_gold', name: 'Midas Touch', description: 'Earn 50,000 gold', target: 50000, rewards: {'crystals': 40, 'echoes': 100}),
      () => WeeklyChallenge(id: 'w_boss', name: 'Boss Hunter', description: 'Defeat 10 bosses', target: 10, rewards: {'mythril': 20, 'echoes': 150}),
      () => WeeklyChallenge(id: 'w_gauntlet', name: 'Iron Will', description: 'Complete 5 gauntlet runs', target: 5, rewards: {'echoes': 250, 'crystals': 20}),
      () => WeeklyChallenge(id: 'w_stages', name: 'Pathfinder', description: 'Clear 25 campaign stages', target: 25, rewards: {'shards': 150, 'crystals': 35}),
