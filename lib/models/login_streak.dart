class LoginReward {
  ...
  static const cycle = [
    ...
    LoginReward(day: 13, shards: 225, label: '225 Shards',       icon: '✨'),
    ...
    LoginReward(day: 27, shards: 600, echoes: 150, label: '600◆ + 150🔊', icon: '✨'),
