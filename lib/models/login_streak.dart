class LoginReward {
  ...
  static const cycle = [
    ...
    LoginReward(day: 2,  crystals: 10, label: '10 Crystals',    icon: '💎'),
    LoginReward(day: 3,  shards: 30, echoes: 30, label: '30 Shards + 30 Echoes', icon: '◆'),
    LoginReward(day: 4,  mythril: 6,  label: '6 Mythril',       icon: '⬡'),
    LoginReward(day: 5,  crystals: 30, gold: 2000, label: '2000 Gold + 30 💎', icon: '🎁'),
    LoginReward(day: 6,  shards: 100, essence: 200, label: '100 Shards + 200 Essence', icon: '✨'),
    LoginReward(day: 7,  crystals: 100, echoes: 100, label: '100 Crystals + 100 Echoes', icon: '👑'),
    // Week 2
    ...
    LoginReward(day: 12, crystals: 20, gold: 2500, label: '2500 Gold + 20 💎', icon: '🎁'),
    LoginReward(day: 13, shards: 75, essence: 150, label: '75 Shards + 150 Essence', icon: '✨'),
    LoginReward(day: 14, crystals: 50, echoes: 75, isEpicItem: true, label: '50💎 + 75🔊 + Epic Item!', icon: '👑'),
    // Week 3
    LoginReward(day: 15, gold: 2000,  label: '2000 Gold',       icon: '💰'),
    LoginReward(day: 16, crystals: 25, label: '25 Crystals',    icon: '💎'),
    LoginReward(day: 17, echoes: 100, label: '100 Echoes',      icon: '🔊'),
    LoginReward(day: 18, mythril: 15, label: '15 Mythril',      icon: '⬡'),
    LoginReward(day: 19, crystals: 40, gold: 3000, label: '3000 Gold + 40 💎', icon: '🎁'),
    LoginReward(day: 20, shards: 150, essence: 300, label: '150 Shards + 300 Essence', icon: '✨'),
    LoginReward(day: 21, crystals: 75, echoes: 100, label: '75 Crystals + 100 Echoes', icon: '👑'),
    // Week 4 — grand finale
    ...
    LoginReward(day: 26, crystals: 50, gold: 5000, label: '5000 Gold + 50 💎', icon: '🎁'),
    LoginReward(day: 27, shards: 200, essence: 400, echoes: 150, label: '200◆ + 400✦ + 150🔊', icon: '✨'),
    LoginReward(day: 28, crystals: 100, label: '100 Crystals',  icon: '💎'),
    LoginReward(day: 29, gold: 10000, crystals: 50, echoes: 200, label: '10K Gold + 50💎 + 200🔊', icon: '🎁'),
