                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(children: [
                              Expanded(child: _buildDndStat('STR',
                                  game.hero.power, game.hero.strMod)),
                              const SizedBox(width: 5),
                              Expanded(child: _buildDndStat('DEX',
                                  game.hero.agility, game.hero.dexMod)),
                              const SizedBox(width: 5),
                              Expanded(child: _buildDndStat('CON',
                                  game.hero.vitality, game.hero.conMod)),
                            ]),
                            const SizedBox(height: 5),
                            Row(children: [
                              Expanded(child: _buildDndStat('INT',
                                  game.hero.arcane, game.hero.intMod)),
                              const SizedBox(width: 5),
                              Expanded(child: _buildDndStat('WIS',
