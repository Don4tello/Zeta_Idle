...
class EnemyData {
  static final enemies = <Enemy>[
    // ── Undead ──────────────────────────────────────────────────────────────
    Enemy(
      id: 'skeleton', name: 'Skeleton', level: 1, maxHealth: 100, attack: 4, armorClass: 0,
    ...
    Enemy(
      id: 'mummy', name: 'Mummy', level: 8, maxHealth: 330, attack: 18, armorClass: 4,
      attackType: DamageType.physical,
    ...
    // ── Beasts & Constructs ──────────────────────────────────────────────────
    Enemy(
      id: 'harpy', name: 'Harpy', level: 4, maxHealth: 155, attack: 11, armorClass: 2,
      attackType: DamageType.physical,
      resistances: {DamageType.lightning: 25},
      description: 'A winged terror that dives from above with murderous precision.',
    ),
    Enemy(
      id: 'gargoyle', name: 'Gargoyle', level: 7, maxHealth: 300, attack: 18, armorClass: 5,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'basilisk', name: 'Basilisk', level: 7, maxHealth: 320, attack: 19, armorClass: 3,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'golem', name: 'Golem', level: 9, maxHealth: 400, attack: 18, armorClass: 4,
      attackType: DamageType.physical,
    ...
    // ── Crystal & Arcane ─────────────────────────────────────────────────────
    Enemy(
      id: 'crystal_shard', name: 'Crystal Shard', level: 13, maxHealth: 700, attack: 52, armorClass: 5,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'gem_serpent', name: 'Gem Serpent', level: 14, maxHealth: 800, attack: 55, armorClass: 6,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'crystal_guardian', name: 'Crystal Guardian', level: 14, maxHealth: 740, attack: 57, armorClass: 9,
      attackType: DamageType.physical,
    ...
    // ── Shadow & Darkness ────────────────────────────────────────────────────
    Enemy(
      id: 'shadow_stalker', name: 'Shadow Stalker', level: 15, maxHealth: 580, attack: 70, armorClass: 5,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'shade_assassin', name: 'Shade Assassin', level: 15, maxHealth: 530, attack: 76, armorClass: 4,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'umbral_knight', name: 'Umbral Knight', level: 16, maxHealth: 760, attack: 73, armorClass: 10,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'glacial_troll', name: 'Glacial Troll', level: 18, maxHealth: 950, attack: 95, armorClass: 8,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'storm_giant', name: 'Storm Giant', level: 20, maxHealth: 1250, attack: 126, armorClass: 8,
      attackType: DamageType.physical,
    ...
    // ── Deep Sea & Abyss ─────────────────────────────────────────────────────
    Enemy(
      id: 'deep_lurker', name: 'Deep Lurker', level: 21, maxHealth: 1050, attack: 146, armorClass: 6,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'abyssal_shark', name: 'Abyssal Shark', level: 22, maxHealth: 1300, attack: 150, armorClass: 7,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'sea_colossus', name: 'Sea Colossus', level: 22, maxHealth: 1600, attack: 148, armorClass: 10,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'assembly_drone', name: 'Assembly Drone', level: 25, maxHealth: 1700, attack: 208, armorClass: 9,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'vault_guardian', name: 'Vault Guardian', level: 26, maxHealth: 2100, attack: 215, armorClass: 12,
      attackType: DamageType.physical,
      resistances: {DamageType.physical: 50, DamageType.poison: 75, DamageType.cold: 25, DamageType.lightning: -25},
    ...
    // ── Imprisoned Horrors ───────────────────────────────────────────────────
    Enemy(
      id: 'shackle_beast', name: 'Shackle Beast', level: 33, maxHealth: 4200, attack: 388, armorClass: 9,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'containment_golem', name: 'Containment Golem', level: 34, maxHealth: 5500, attack: 390, armorClass: 14,
      attackType: DamageType.physical,
      resistances: {DamageType.physical: 50, DamageType.poison: 75, DamageType.cold: 25, DamageType.lightning: -25},
      description: 'A construct powered by the prison\'s containment core, built to seal the unsealed and chain the unchained.',
    ),
    Enemy(
      id: 'cell_breaker', name: 'Cell Breaker', level: 34, maxHealth: 4800, attack: 405, armorClass: 9,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'siege_engine', name: 'Siege Engine', level: 36, maxHealth: 7000, attack: 442, armorClass: 14,
      attackType: DamageType.physical,
      resistances: {DamageType.physical: 50, DamageType.poison: 75, DamageType.lightning: -25},
      description: 'A forgotten weapon of war set to fire at anything that comes close to the gate. You are close to the gate.',
    ),
    Enemy(
      id: 'gate_colossus', name: 'Gate Colossus', level: 37, maxHealth: 9500, attack: 480, armorClass: 16,
      attackType: DamageType.physical,
    ...
    Enemy(
      id: 'minotaur', name: 'Minotaur', level: 10, maxHealth: 240, attack: 20, armorClass: 3,
      attackType: DamageType.physical,
      resistances: {DamageType.physical: 15},
    ...
    Enemy(
      id: 'pharaoh_kethran', name: 'Pharaoh Kethran', level: 9, maxHealth: 850, attack: 55, armorClass: 7,
    ...
    Enemy(
      ...
      abilities: [
        ...
        BossAbility(id: 'emperor_overload', name: 'Overload',         emoji: '???', damageType: DamageType.lightning, effect: BossAbilityEffect.stun,        value: 1,   cooldownRounds: 6),
      ],
    ),
    Enemy(
      ...
      abilities: [
        BossAbility(id: 'rot_burst',        name: 'Plague Burst',    emoji: '??',  damageType: DamageType.poison,   effect: BossAbilityEffect.bonusDamage, value: 90, cooldownRounds: 4),
    ...
    Enemy(
      ...
      abilities: [
        BossAbility(id: 'titan_slam',       name: 'Gate Slam',       emoji: '???', damageType: DamageType.physical, effect: BossAbilityEffect.bonusDamage, value: 140, cooldownRounds: 4),
  ...
  static Enemy enemyForStage(int stage, {List<ZoneAffix> affixes = const [], int prestigeLevel = 0}) {
    ...
    final double growth = a <= 100
        ? pow(1.08, a).toDouble()
        : pow(1.08, 100).toDouble() * (1.0 + (a - 100) * 0.03);
